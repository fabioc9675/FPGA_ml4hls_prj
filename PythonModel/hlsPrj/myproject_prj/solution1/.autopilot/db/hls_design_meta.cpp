...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("result1", 32, hls_out, 7, "ap_vld", "out_data", 1),
	Port_Property("result1_ap_vld", 1, hls_out, 7, "ap_vld", "out_vld", 1),
	Port_Property("result2", 32, hls_out, 8, "ap_vld", "out_data", 1),
	Port_Property("result2_ap_vld", 1, hls_out, 8, "ap_vld", "out_vld", 1),
	Port_Property("result", 32, hls_out, 9, "ap_vld", "out_data", 1),
	Port_Property("result_ap_vld", 1, hls_out, 9, "ap_vld", "out_vld", 1),
};
