...
set name GN_inference_fmul_32ns_32ns_32_4_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmul} IMPL {maxdsp} LATENCY 3 ALLOW_PRAGMA 1
}


set name GN_inference_sitofp_32ns_32_6_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {sitofp} IMPL {auto} LATENCY 5 ALLOW_PRAGMA 1
}


set name GN_inference_fpext_32ns_64_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 34
set name GN_inference_mul_mul_8s_10ns_19_1_1
...
set in1_signed 0
set out_width 19
set arg_lists {i0 {8 1 +} i1 {10 0 +} p {19 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_result2 \
    op interface \
    ports { result2 { O 32 vector } result2_ap_vld { O 1 bit } } \
} "
}
